...
import cn.bywin.business.service.bydb.TruUdfService;
...
@CrossOrigin(value = {"*"},
        ...
        maxAge = 3600)
@RestController
@Api(tags = "可信建模-UDF管理-truudf" )
@RequestMapping("/truudf")
public class TruUdfController extends BaseController {
    protected final Logger logger = LoggerFactory.getLogger(this.getClass());

    @Autowired
    private TruUdfService udfService;

    @Value( "${truudfdbtype:flink_1_14_4}" )
    ...
    @ResponseBody
    public Object add(@RequestBody TTruUdfDo info, HttpServletRequest request) {
...
//            resMap.put("treeNode", data );
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "modelVo", value = "bydbUDF", dataType = "TTruUdfDo", required = true, paramType = "body")
    })
    ...
    public Object update(HttpServletRequest request) {
        ...
        try {
            ...
            TTruUdfDo oldData = new TTruUdfDo();
...
//            }
    ...
    public Object info(String id) {
        ...
        try {
            ...
            TTruUdfDo modelVo = udfService.findById(id);
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "modelVo", value = "UDF信息", dataType = "TTruUdfDo", required = false, paramType = "query")
    })
    @RequestMapping(value = "/page", method = {RequestMethod.GET})
    @ResponseBody
    public Object page(TTruUdfDo modelVo) {
        ResponeMap resMap = this.genResponeMap();
        try {
            modelVo.setQryCond( ComUtil.chgLikeStr(modelVo.getQryCond()));
            //modelVo.setDbName(ComUtil.chgLikeStr(modelVo.getDbName()));

            List<TTruUdfDo> list = udfService.findBeanList(modelVo);
    ...
    public Object option( String belongType ,String datasetId,String databaseId,String datasourceId,String qryCond ) {
        ...
        try {
            ...
            TTruUdfDo modelVo =new TTruUdfDo();
