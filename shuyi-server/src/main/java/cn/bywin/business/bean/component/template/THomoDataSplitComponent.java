 ...
 */
@Data
public class THomoDataSplitComponent extends BaseComponenT {


    private double validate_size = 0.3;
    private boolean stratified = true;
    public THomoDataSplitComponent(){}
    ...
    public Object init(FModelElementDo preModelElementDo) {
        ...
        THomoDataSplitComponent homoDataSplitComponentT=new THomoDataSplitComponent();


        return JsonUtil.toSimpleJson(homoDataSplitComponentT);
    }
