...
import static cn.bywin.business.bean.analysis.TruComponentEnum.Collection_COMPONENT;
...
@Data
public class TruCollectionComponent extends TruBaseComponenT {
    ...
    public TruNode init( TruNode truNode, TTruModelElementDo fModelElementDo) throws Exception {
        if (StringUtils.isNotBlank(fModelElementDo.getConfig())) {
            ...
            TruCollectionComponent collectionComponent = JsonUtil.gson().fromJson(JsonUtil.toJson(config), TruCollectionComponent.class);
    ...
    public TruCheckComponent check( TruNode truNode, TTruModelElementDo fModelElementDo) throws Exception {
        TruCollectionComponent collectionComponent = JsonUtil.gson().fromJson(JsonUtil.toJson( truNode.getParams()), TruCollectionComponent.class);
    ...
    public void build( TruNode truNode, TTruModelElementDo fModelElementDo, TTruModelDo  model) throws Exception {
        ...
        if( !"tee".equalsIgnoreCase( model.getConfig() ) && !"flink".equalsIgnoreCase( model.getConfig() ) ) {
            ...
            sql.append( " " ).append( leftpre ).append( " " ).append( collectionComponent.getCollectionType().toUpperCase() );
            sql.append( " SELECT " ).append( String.join( ",", rightFieldDos ) ).append( " FROM " );
